 ...
 do i = 1, ao_num
  do j = 1, ao_num
   do ipoint = 1, n_points_final_grid
    ...
    ao_magdip_x_becke(j,i) +=  weight * ((aos_in_r_array_transp(ipoint,j)*r(2)*aos_grad_in_r_array_transp_bis(ipoint,i,3))&
                                          -(aos_in_r_array_transp(ipoint,j)*r(3)*aos_grad_in_r_array_transp_bis(ipoint,i,2 )))
    ao_magdip_y_becke(j,i) +=  weight * ((aos_in_r_array_transp(ipoint,j)*r(3)*aos_grad_in_r_array_transp_bis(ipoint,i,1))&
                                          -(aos_in_r_array_transp(ipoint,j)*r(1)*aos_grad_in_r_array_transp_bis(ipoint,i,3 )))
    ao_magdip_z_becke(j,i) +=  weight * ((aos_in_r_array_transp(ipoint,j)*r(1)*aos_grad_in_r_array_transp_bis(ipoint,i,2))&
