...
! \end{align*}
 ...
 BEGIN_PROVIDER [double precision, multi_s_magdipole_moment  , (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_x_magdipole_moment, (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_y_magdipole_moment, (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_z_magdipole_moment, (N_states, N_states)]
  ...
  multi_s_x_magdipole_moment = 0.d0
  multi_s_y_magdipole_moment = 0.d0
  multi_s_z_magdipole_moment = 0.d0
  ...
  do istate = 1, N_states
    multi_s_x_magdipole_moment(istate,istate) += nuclei_part_x
    multi_s_y_magdipole_moment(istate,istate) += nuclei_part_y
    multi_s_z_magdipole_moment(istate,istate) += nuclei_part_z
  enddo
 
  ! d = <Psi|r|Psi>
  do jstate = 1, N_states
    do istate = 1, N_states
      multi_s_magdipole_moment(istate,jstate) = &
        dsqrt(multi_s_x_magdipole_moment(istate,jstate)**2 & 
            + multi_s_y_magdipole_moment(istate,jstate)**2 &
            + multi_s_z_magdipole_moment(istate,jstate)**2) 
    enddo
  enddo
...
! ---
 ...
 BEGIN_PROVIDER [double precision, multi_s_x_magdipole_moment_eigenvec, (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_y_magdipole_moment_eigenvec, (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_z_magdipole_moment_eigenvec, (N_states, N_states)]
&BEGIN_PROVIDER [double precision, multi_s_x_magdipole_moment_eigenval,           (N_states)]
&BEGIN_PROVIDER [double precision, multi_s_y_magdipole_moment_eigenval,           (N_states)]
&BEGIN_PROVIDER [double precision, multi_s_z_magdipole_moment_eigenval,           (N_states)]

  implicit none
  double precision, allocatable :: eigval(:), eigvec(:,:), A(:,:)

  PROVIDE multi_s_x_magdipole_moment multi_s_y_magdipole_moment multi_s_z_magdipole_moment

  allocate(A(N_states,N_states), eigvec(N_states,N_states), eigval(N_states))

  A = multi_s_x_magdipole_moment
  call lapack_diag(eigval(1), eigvec(1,1), A(1,1), N_states, N_states)
  multi_s_x_magdipole_moment_eigenval = eigval
  multi_s_x_magdipole_moment_eigenvec = eigvec

  A = multi_s_y_magdipole_moment
  call lapack_diag(eigval(1), eigvec(1,1), A(1,1), N_states, N_states)
  multi_s_y_magdipole_moment_eigenval = eigval
  multi_s_y_magdipole_moment_eigenvec = eigvec

  A = multi_s_z_magdipole_moment
  call lapack_diag(eigval(1), eigvec(1,1), A(1,1), N_states, N_states)
  multi_s_z_magdipole_moment_eigenval = eigval
  multi_s_z_magdipole_moment_eigenvec = eigvec
